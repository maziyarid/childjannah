...
// CONSTANTS
// =============================================
if (!defined('TEZ_VERSION')) define('TEZ_VERSION', '2.4.0');
if (!defined('TEZ_PHONE')) define('TEZ_PHONE', '09331663849');
if (!defined('TEZ_PHONE_DISPLAY')) define('TEZ_PHONE_DISPLAY', '09331663849');
if (!defined('TEZ_WHATSAPP')) define('TEZ_WHATSAPP', '989331663849');
...
// =============================================
// CRITICAL CSS - FIXED (no *{font-family:inherit})
// =============================================
if (!function_exists('tez_output_critical_css')) {
    function tez_output_critical_css() {
        echo '<style id="tez-critical-css">
:root{--tez-primary:#2563eb;--tez-secondary:#1FA640;--tez-bg:#fff;--tez-text:#111827;--tez-border:#e5e7eb;--tez-font:"Irancell","Tahoma","Arial",system-ui,sans-serif}
...
// =============================================
// FONT AWESOME FIX CSS (FA7 + fallbacks)
// =============================================
...
<div class="tez-theme-buttons" id="tez-theme-buttons" role="toolbar">
    <button type="button" class="tez-mode-btn active" data-theme="light" title="حالت روشن" aria-pressed="true">
        <i class="fa-solid fa-sun"></i>
    </button>
    <button type="button" class="tez-mode-btn" data-theme="dark" title="حالت تاریک" aria-pressed="false">
        <i class="fa-solid fa-moon"></i>
    </button>
    <button type="button" class="tez-mode-btn" data-theme="sepia" title="حالت کتاب" aria-pressed="false">
        <i class="fa-solid fa-book-open"></i>
    </button>
</div>

<div class="tez-a11y-toolbar" id="tez-a11y-toolbar" role="toolbar">
    <button type="button" class="tez-a11y-btn" data-action="increase-font" title="افزایش متن">
        <i class="fa-solid fa-plus"></i>
    </button>
    <button type="button" class="tez-a11y-btn" data-action="decrease-font" title="کاهش متن">
        <i class="fa-solid fa-minus"></i>
    </button>
    <button type="button" class="tez-a11y-btn" data-action="high-contrast" title="کنتراست">
        <i class="fa-solid fa-circle-half-stroke"></i>
    </button>
    <button type="button" class="tez-a11y-btn" data-action="reset" title="بازنشانی">
        ...
        <div class="tez-header-inner">
            ...
            <nav class="tez-main-nav" id="tez-main-nav" role="navigation">
                ...
                if (has_nav_menu('tez_primary')) {
                    ...
                    echo '<li class="tez-menu-item"><a href="' . esc_url($home) . '" class="tez-nav-link"><span>خانه</span></a></li>';
                    echo '<li class="tez-menu-item"><a href="#" class="tez-nav-link"><span>خدمات</span></a></li>';
                    echo '<li class="tez-menu-item"><a href="#" class="tez-nav-link"><span>درباره ما</span></a></li>';
                    echo '<li class="tez-menu-item"><a href="#" class="tez-nav-link"><span>تماس</span></a></li>';
                    echo '</ul>';
                }
                ?>
            </nav>
            ...
            <div class="tez-header-actions">
                <a href="tel:<?php echo esc_attr($phone); ?>" class="tez-action-btn tez-phone-btn" title="تماس">
                    <i class="fa-solid fa-phone"></i>
                </a>
                <button type="button" class="tez-action-btn tez-search-btn" id="tez-search-toggle" title="جستجو">
...
<nav class="tez-mobile-menu" id="tez-mobile-menu" role="dialog" aria-hidden="true">
    <div class="tez-mobile-header">
        ...
        <button type="button" class="tez-mobile-close" id="tez-mobile-close" aria-label="بستن">
    ...
    <div class="tez-mobile-body">
        <ul class="tez-mobile-nav">
            ...
            if (has_nav_menu('tez_mobile')) {
                ...
                echo '<li class="tez-mobile-menu-item"><a href="#" class="tez-mobile-link">خدمات</a></li>';
                echo '<li class="tez-mobile-menu-item"><a href="#" class="tez-mobile-link">درباره ما</a></li>';
                echo '<li class="tez-mobile-menu-item"><a href="#" class="tez-mobile-link">تماس</a></li>';
            }
            ?>
        </ul>
    </div>
    <div class="tez-mobile-footer">
        <a href="tel:<?php echo esc_attr($phone); ?>" class="tez-mobile-phone">
            <i class="fa-solid fa-phone"></i>
            <span><?php echo esc_html($phone_display); ?></span>
        </a>
        <a href="<?php echo esc_url($inquiry); ?>" class="tez-btn tez-btn-primary tez-btn-block">
            <i class="fa-solid fa-pen-to-square"></i> ثبت سفارش
        </a>
    </div>
</nav>
...
<div class="tez-search-overlay" id="tez-search-overlay" role="dialog" aria-hidden="true">
    <div class="tez-search-container">
        <button type="button" class="tez-search-close" id="tez-search-close" aria-label="بستن">
            <i class="fa-solid fa-xmark"></i>
        </button>
        <form class="tez-search-form" role="search" method="get" action="<?php echo esc_url($home); ?>">
            <div class="tez-search-input-wrap">
                ...
                <button type="submit" class="tez-search-submit">
                    <i class="fa-solid fa-magnifying-glass"></i>
                </button>
            </div>
        </form>
