<?php
/**
 * SEO Redirects - Remove date archives, author archives
 * Consolidated from multiple snippet files.
 *
 * @package JannahChild
 * @version 2.4.0
 */
...
// =============================================
// PART 1: Redirect date-based archives to homepage
// Source: Snippets/Remove & Redirect Date Archive pages.php
// =============================================
...
// =============================================
// PART 2: Remove Author Archives & Disable Author Links
// Source: Snippets/Remove Author Archives & Disable Author Links.php
// =============================================
...
function tez_author_link_css() {
    ...
    .author-name { font-weight: inherit; color: inherit; }
    .author-box, .tie-author-box, .single-post-meta .author, .post-author { display: block; }
    .author-box a[href*="/author/"], .tie-author-box a[href*="/author/"] {
